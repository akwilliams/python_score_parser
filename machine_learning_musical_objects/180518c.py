...
#                cv2.destroyAllWindows()
    ...
    for index_0 in range(len(container_df)):
      ...
      if container_df[index_0].shape[0]<2500:
        ...
        cv2.imwrite('output/result_'+str(index_0)+'.png',img_dup_2)          
        cv2.imwrite('output/template_'+str(index_0)+'.png',container_template[index_0])    
...
df_0,img=init_img_filter(path+'img_19.png')
